...
(function() {
    ...
    var context = document.getElementById('flying-bird').getContext('2d'), 
        filedContext = document.getElementById('backward-field').getContext('2d');
