...
var is = {
    ...
    set: function (shape) {
        ...
        cache.isLine = cache.isArc = cache.isDragLastPath = cache.isDragAllPaths = cache.isRectangle = cache.isQuadraticCurve = cache.isBezierCurve = false;
        cache['is' + shape] = true;
    }
};
...
function getContext(id) {
    ...
    canv.setAttribute('height', innerHeight - canv.offsetTop - 80);
...
var common = {
    ...
    relativeShortened: function (toFixed, getPoint) {
        var i = 0, point, p, length = points.length, output = '', x = 0, y = 0;
    ...
    relativeNOTShortened: function (toFixed, getPoint) {
        var i, point, p, length = points.length, output = '', x = 0, y = 0;
...
var copiedStuff = [], isControlKeyPressed;
